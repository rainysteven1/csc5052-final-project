...
const pollingEnabled = (process.env.VITE_USE_POLLING || "true").toLowerCase() !== "false";
const pollingInterval = Number.parseInt(process.env.VITE_POLLING_INTERVAL || "1000", 10);
