...
export function LiveRuntimePanel({ latestMessage, latestTime }: LiveRuntimePanelProps) {
  return (
    <PipelineSectionBlock label="Live stream watch" className="h-full" bodyClassName="space-y-3">
      <PipelineInfoBlock
        label="Latest packet"
        value={latestMessage || "Waiting for the backend to emit the first SSE event."}
