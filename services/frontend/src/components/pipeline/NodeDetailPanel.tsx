...
import { asRecord, buildNodeDetails, getActiveSubstep, getWorkflowSubsteps, normalizeAnalysisState, prettifyNode } from "@/lib/analysis-helpers";
...
export function NodeDetailPanel() {
  ...
  return (
    <PageSectionCard eyebrow="Spotlight" title={detail.title} contentClassName="flex flex-col gap-4">
