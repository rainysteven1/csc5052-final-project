...
import { PipelineViewTabs, type PipelineView } from "@/components/pipeline/PipelineViewTabs";
...
export function PipelineControlBar({ activeView, onChange }: PipelineControlBarProps) {
  ...
  const frameLabel = mode === "replay" ? `Frame ${replayCursor + 1}` : `${eventsCount} events`;
