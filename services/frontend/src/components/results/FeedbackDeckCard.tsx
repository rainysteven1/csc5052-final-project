...
export function FeedbackDeckCard({
  ...
  const practicePreview = practiceSteps[0] || practice || "No practice action captured.";
  const evidencePreview = evidenceSources.length ? evidenceSources.join(" · ") : "No evidence linked";
  const statBlocks = [
  ...
  return (
    ...
    >
      <div className="grid gap-3 xl:grid-cols-[1fr_1.1fr_0.9fr] xl:items-center">
        ...
        <div className="min-w-0">
          <div className="console-index-label">
            Practice cue
          </div>
