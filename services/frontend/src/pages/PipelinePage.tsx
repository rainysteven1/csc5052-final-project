...
export function PipelinePage() {
  ...
  const pipelineScrollTarget = useAnalysisStore(
    (state) => state.pipelineScrollTarget
  );
  const consumePipelineScrollTarget = useAnalysisStore(
    (state) => state.consumePipelineScrollTarget
  );
