...
export function ReplayControls() {
  ...
  if (mode !== "replay" || events.length === 0) {
    return (
      <div className="flex min-h-[112px] items-center rounded-[24px] border border-dashed bg-background/40 px-4 text-sm text-muted-foreground">
  ...
  return (
    <div className="grid gap-3 rounded-[24px] border bg-background/70 p-4 md:grid-cols-[minmax(0,1fr)_360px] md:items-center">
