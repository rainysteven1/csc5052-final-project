"""gRPC client for calling the ASR microservice."""
...
from services.asr.src.client import RemoteAsrError
...
from services.gen.speaksure.v1 import asr_service_pb2, asr_service_pb2_grpc
