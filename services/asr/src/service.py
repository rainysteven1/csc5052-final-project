"""ASR service logic for transcript lookup and remote transcription."""
...
from services.asr.src.backends import OnnxWhisperBackendError, transcribe_with_onnx_whisper
from services.asr.src.client import RemoteAsrError, transcribe_with_remote_asr
from services.asr.src.transports.grpc_client import transcribe_with_grpc_asr
...
def _fallback_transcript(audio_path: Path) -> str:
    ...
    if not stem:
        return "This is a placeholder transcript for the uploaded audio."
    return f"This is a placeholder transcript for {stem}."
